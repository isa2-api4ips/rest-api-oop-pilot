...
public enum APIProblemType {
    ...
    NO_RECIPIENT("NoFinalRecipient", "no-final-recipient", 400, true, true, "Pull Error: No final recipient configured for the pulling user", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#pull/no-final-recipient", "Sent when the server cannot resolve/match the pulling user to a final recipient", null),
    PULL_NO_MESSAGE("NoMessageFound", "no-message-found", 404, true, true, "Pull Error: No Message Found", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#pull/no-message-found", "Sent when no message is found that maps to the pull request", null),
    PULL_UNAUTHORIZED("Unauthorized", "unauthorized", 401, true, true, "Pull Error: Unauthorized", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#pull/unauthorized", "Sent when the pull request is unauthorized", null),
    PULL_MESSAGE_READY("MessageReady", "message-ready", 201, false, true, "Message Response is ready", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#message-ready", "An HTTP Request following [RFC7807] MUST be sent when a message response is ready to be retrieved", null),
    // added by implementation
    INTERNAL_SERVER_ERROR("ServerError", "server-error", 500, true, false, "Server Error", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#server-error", "Sent when a server error occurred that does not affect the signalling process", null);
