...
public enum APIProblemType {
    ...
    PULL_NO_MESSAGE("NoMessageFound", "no-message-found", 404, true, true, "No Message Found", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#pull/no-message-found", "Sent when no message is found that maps to the pull request", null),
    PULL_UNAUTHORIZED("Unauthorized", "unauthorized", 401, true, true, "Unauthorized", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#pull/unauthorized", "Sent when the pull request is unauthorized", null),
    PULL_MESSAGE_READY("MessageReady", "message-ready", 201, false, true, "Message Response is ready", "https://github.com/isa2-api4ips/rest-api-profile/blob/main/messaging-api-specification/signal.md#message-ready", "An HTTP Request following [RFC7807] MUST be sent when a message response is ready to be retrieve", null),
