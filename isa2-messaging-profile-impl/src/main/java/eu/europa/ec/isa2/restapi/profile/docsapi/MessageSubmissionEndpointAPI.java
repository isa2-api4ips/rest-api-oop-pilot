...
@RequestMapping("/v1")
@Tag(name = MessageSubmissionEndpointAPI.TAG_MESSAGE_SUBMISSION, description = "The Message Submission endpoints are providing the endpoint to which a client sends the message.")
public interface MessageSubmissionEndpointAPI {
