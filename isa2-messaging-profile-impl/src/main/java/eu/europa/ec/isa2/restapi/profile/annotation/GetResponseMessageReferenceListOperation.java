...
@HttpMethod("GET")
public @interface GetResponseMessageReferenceListOperation {
    ...
    MessageReferencePullOperationType operationType() default MessageReferencePullOperationType.RESPONSE_ALL;
