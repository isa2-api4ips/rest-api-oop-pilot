...
public class LoggingConfigurator {
    ...
    private String getLoggingConfigurationFile() {
        if (StringUtils.isBlank(NationalBrokerProperties.NATIONAL_BROKER_CONFIG_LOCATION)) {
            return null;
        }
        return NationalBrokerProperties.NATIONAL_BROKER_CONFIG_LOCATION + File.separator + LoggingConfigurator.DEFAULT_LOGBACK_FILE_NAME;
    }
