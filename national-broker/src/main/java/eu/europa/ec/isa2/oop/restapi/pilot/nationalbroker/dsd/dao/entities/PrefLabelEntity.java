...
@Entity
@Table(name = "NB_DSD_ORG_PREFLABEL")
public class PrefLabelEntity extends AbstractStringEntity {
    @Id
    @GenericGenerator(name = "NB_DSD_ORG_PREFLABEL_SEQ", strategy = "native")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "NB_DSD_ORG_PREFLABEL_SEQ")
    @Column(name = "ID_PK")
    private Long id;
