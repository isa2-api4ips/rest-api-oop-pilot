...
@Entity
@Table(name = "DSD_MOCK_ORG_CLASSIFICATION")
public class ClassificationEntity extends AbstractStringEntity {
    @Id
    @GenericGenerator(name = "DSD_MOCK_ORG_CLASS_SEQ", strategy = "native")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "DSD_MOCK_ORG_CLASS_SEQ")
    @Column(name = "ID_PK")
    private Long id;
