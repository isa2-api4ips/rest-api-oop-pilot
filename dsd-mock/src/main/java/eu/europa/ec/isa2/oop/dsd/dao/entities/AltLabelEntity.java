...
@Entity
@Table(name = "DSD_MOCK_ORG_ALTLABEL")
public class AltLabelEntity extends AbstractStringEntity {
    @Id
    @GenericGenerator(name = "DSD_MOCK_ORG_ALTLABEL_SEQ", strategy = "native")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "DSD_MOCK_ORG_ALTLABEL_SEQ")
    @Column(name = "ID_PK")
    private Long id;
