...
public class OrganizationSearchParameters {
    ...
    @Schema(name = "queryId", title = "Identifier of the query",
            ...
            defaultValue = "urn:toop:dsd:ebxml-regrem:queries:ByOrganizationIdAndName", example = "urn:toop:dsd:ebxml-regrem:queries:ByOrganizationIdAndNameta  t")
    String queryId;

    public OrganizationSearchParameters() {}
    public OrganizationSearchParameters(String country, String name, Integer limit, Integer offset, String sort) {
